...
function createTasksTools({
  ...
  Object.assign(tools, {
    ...
    async tasks_decision(args = {}) {
      ...
      // Потолок — OPEN_DECISIONS_CAP, сейчас десять. Доска, на которой уже
      // висит десять нерешённых развилок, не станет полезнее от одиннадцатой —
