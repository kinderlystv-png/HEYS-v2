...
//   — RPE (субъективная тяжесть сессии) не собирается нигде в схеме — иначе
//     это был бы естественный общий знаменатель для кардио и силовой
//     (session-RPE × длительность). Если RPE появится в heys_log_training,
//     часть про «раздельные ряды» выше отпадёт.
