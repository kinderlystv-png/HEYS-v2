...
const TASKS_INSTRUCTIONS = [
  ...
  '31. Поставил слот — прочитай в ответе conflicts. Есть пересечение, назови его вслух сразу: доска рисует слоты друг поверх друга и сама об этом не скажет.',
  '32. Крупный блок присутствия («дом у родителей», «студия весь день») ставь с presence: true — иначе он закроет собой слоты задач внутри себя.',
