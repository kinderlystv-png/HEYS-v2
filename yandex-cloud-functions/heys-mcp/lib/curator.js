...
const TASKS_INSTRUCTIONS = [
  ...
  'З41. tasks_mcp_trace — разбор цепочки вызовов MCP по обмену из стенограммы: когда «почему долго», «сколько кругов», «что дергалось между вопросом и ответом». Не на каждый tasks_read — только по запросу или когда время ответа подозрительное.',
];
