...
const DAY_AFTER_RULE = ' В ответе приходит day_after — день по версии сервера: сверь с тем, чего ждал (приёмов больше на один, калории выросли на внесённое). Не сошлось — скажи куратору, а не отчитывайся «внёс». Из outcome вслух называй только stale_write_blocked: запись отбросили, её нет.';
