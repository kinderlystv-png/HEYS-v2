 ...
 *
 * Kill switch остаётся серверным: access-токен несёт в себе зашифрованный
 * HEYS client-session token, поэтому `revoke_session` мгновенно обрывает
 * доступ агента — отдельный revocation-стор не нужен.
 */
