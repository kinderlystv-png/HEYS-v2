...
/* ✅ Правильно — BEM */
.water-tracker { }                    /* Block */
.water-tracker__button { }            /* Element */
.water-tracker__button--active { }    /* Modifier */
...
> `pnpm css:audit` теперь считает только реальные `!important` (по вхождению `!important`, без ложных совпадений в слове “important”).
...
- При следующей загрузке: `[HEYS] Orphan product: "Название" — используются данные из штампа`
