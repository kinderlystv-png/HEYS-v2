...
## 🤖 AI Workflow Rules
1. **HMR работает** - Vite автоматически применяет изменения, НЕ перезапускай сервер без причины
2. **Коммиты только по запросу** - показывай изменения, жди команды "коммит" или "пуш"
