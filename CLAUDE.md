...
**Конкурентный эталон.** Лендинг и клиент-видимые функции приложения доводятся
до «идеальной конкурентной комбинации» из
[`маркетинг/30_Имплемент_мап.md`](маркетинг/30_Имплемент_мап.md) (выведена из
аудита рынка `маркетинг/29`). При любой правке лендинга или клиент-видимых фич:
сверься с мапом, обнови статус пункта в `30` — дашборд
(`маркетинг/00_Дашборд.html`, вкладка «Имплемент-мап») пересоберётся авто-хуком.
Новые заимствования у конкурентов — только через резолюцию в журнале
`маркетинг/15` (§2), не напрямую в код.
