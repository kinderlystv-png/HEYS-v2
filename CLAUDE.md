...
- **Контракт под снимком.** Пакет дизайна приезжает своими коммитами, и строку
  ...
  [`docs/ui/ui-v4-contract-verdicts.json`](docs/ui/ui-v4-contract-verdicts.json)
  вместе с отпечатком значения на момент разбора, а
  `scripts/ui-v4-check-contract-drift.mjs` падает, когда строка изменилась,
  появилась или исчезла. Разобрал изменения — `--rehash <зона>`. Снимок один на
  все канвасы с контрактом: четырнадцать своих механизмов не заводить.
