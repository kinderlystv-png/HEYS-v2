...
**Объясняй простыми словами.** Технические объяснения — через аналогии и
конкретные примеры, без жаргона где это возможно. Если нужно описать архитектуру
или проблему — сначала суть в одном предложении, потом детали.
