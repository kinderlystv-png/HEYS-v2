/*
┌─────────────────────────────────────────────────────────────────────────────────────────┐
│ 🗺️ НАВИГАЦИОННАЯ КАРТА ФАЙЛА heys_analytics_ui.js (445 строк)                           │
├─────────────────────────────────────────────────────────────────────────────────────────┤
│ 📋 СТРУКТУРА ФАЙЛА:                                                                       │
│                                                                                           │
│ ⚛️ КОМПОНЕНТ АНАЛИТИКИ (строки 1-200):                                                   │
│    ├── AnalyticsModal функция (7-50)                                                    │
│    ├── State управление: metrics, tab, autoRefresh (8-10)                               │
│    ├── loadMetrics() - загрузка данных (12-20)                                          │
│    ├── useEffect для автообновления (22-30)                                             │
│    ├── copyToClipboard() - копирование в буфер (32-50)                                  │
│    └── downloadMetrics() - скачивание файла (52-70)                                     │
│                                                                                           │
│ 🎨 RENDER МЕТОДЫ (строки 201-350):                                                       │
│    ├── renderSummaryTab() - сводка (71-120)                                             │
│    ├── renderDetailsTab() - детали (121-170)                                            │
│    ├── renderChartsTab() - графики (171-220)                                            │
│    ├── renderRawDataTab() - сырые данные (221-270)                                      │
│    └── formatValue() - форматирование значений (271-290)                                │
│                                                                                           │
│ 📊 СИСТЕМА ГРАФИКОВ (строки 351-400):                                                    │
│    ├── createPerformanceChart() - график производительности (291-320)                  │
│    ├── createActivityChart() - график активности (321-350)                              │
│    ├── createErrorChart() - график ошибок (351-380)                                     │
│    └── updateCharts() - обновление графиков (381-400)                                   │
│                                                                                           │
│ 🔗 ГЛАВНЫЙ RENDER И ЭКСПОРТ (строки 401-445):                                            │
│    ├── Main render() метод (401-430)                                                     │
│    ├── Modal структура и табы (401-420)                                                 │
│    ├── Кнопки управления (421-430)                                                      │
│    └── HEYS.AnalyticsUI экспорт (431-445)                                               │
│                                                                                           │
├─────────────────────────────────────────────────────────────────────────────────────────┤
│ 🎯 БЫСТРЫЙ ПОИСК:                                                                        │
│    • Компонент: AnalyticsModal (строка 7), main render (401)                           │
│    • Данные: loadMetrics() (12), formatValue() (271)                                    │
│    • Экспорт: copyToClipboard() (32), downloadMetrics() (52)                           │
│    • Графики: createPerformanceChart() (291), updateCharts() (381)                     │
└─────────────────────────────────────────────────────────────────────────────────────────┘
*/
