...
### 1. 🎓 Onboarding Tutorial — Обучение базовым возможностям

**Файл**: <a>docs/tasks/2025-01-06-onboarding-tutorial.md</a>

**Описание**: Интерактивный тур для новых пользователей с 5 шагами (Hero-метрики, Sparkline, FAB кнопки, Инсулиновая волна, Insights). Spotlight-эффект + демо-данные для пустого состояния. Modern UX с анимациями, haptic feedback и конфетти при завершении.

**Цель**: Повысить D1 Retention на 15-20%, снизить когнитивную нагрузку новичков, уменьшить количество базовых вопросов куратору на 30%.

**Время**: ~4-5 часов

**Приоритет**: 🟡 Medium (улучшает onboarding, но не блокирует запуск)

**Статус**: 📋 Готов к реализации (prompt v1.4.0 создан)
