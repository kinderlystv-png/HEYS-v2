...
## 🔥 Рефакторинг (осталось)

### Refactor heys_storage_supabase_v1.js — Storage Layer

**Файл**: [docs/tasks/2026-01-10-refactor-storage-supabase.md](./docs/tasks/2026-01-10-refactor-storage-supabase.md)  
**Описание**: Декомпозиция 6,010 строк → 8 модулей (auth, sync, products, kv, sessions, cloud, utils, main).  
**Время**: ~8-10 часов

- [ ] Выделение auth модуля
- [ ] Выделение sync модуля
- [ ] Выделение products модуля
