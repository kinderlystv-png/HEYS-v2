...
const BASELINE = {
  '000-base-and-gamification.css': 283,
  '001-design-tokens.css': 22,
  '100-metrics-and-graphs.css': 140,
  '1000-messenger.css': 145,
  '200-dark-and-effects.css': 74,
  '300-modals-and-day.css': 82,
  '310-client-switch-overlay.css': 5,
  '400-water-and-hydration.css': 20,
  '500-pwa-and-offline.css': 73,
  ...
  '725-metabolic-intelligence.css': 187,
  '730-widgets-dashboard.css': 176,
  '731-ui-v4-activity.css': 8,
  '732-ui-v4-nutrition.css': 70,
  '733-ui-v4-login-theme.css': 4,
  '733-ui-v4-reports.css': 19,
  '734-ui-v4-curator-panel.css': 15,
  '734-ui-v4-insights.css': 7,
  // 735: появился в task113 (40427c3ae); 4 foreign с первого коммита — не регресс,
  // baseline «0» = файла не было в списке охраны. Полоса 4 · subscription.
  '735-ui-v4-subscription.css': 4,
  '740-cascade-card.css': 14,
  '750-strength-builder.css': 26,
  '900-planning.css': 141,
