...
const BASELINE = {
  '001-design-tokens.css': 1,
  '310-client-switch-overlay.css': 1,
  '400-water-and-hydration.css': 2,
  '500-pwa-and-offline.css': 6,
  '600-steps-and-aps.css': 2,
  '610-aps-meal-flow.css': 4,
  '611-aps-product-card.css': 2,
  '710-refeed.css': 5,
  '715-yesterday-verify.css': 8,
  '731-ui-v4-activity.css': 1,
  '733-ui-v4-login-theme.css': 4,
  '735-ui-v4-subscription.css': 2,
  '750-strength-builder.css': 2,
  '905-planning-chrono.css': 1,
  'critical.css': 3,
  'tailwind.css': 2,
};
