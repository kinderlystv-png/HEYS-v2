export const READING_BOOK_SOURCES = [
    ...
    'reading/books/eckhart-tolle-power-of-now_v1.js',
...
export const LEGACY_BUNDLES = {
    ...
    'boot-app': [
        ...
        'heys_app_nav_icons_v1.js',
        'heys_app_gates_v1.js',
        'heys_client_diagnostics_v1.js',
        ...
        // Панель куратора — содержимое пятой вкладки кабинета.
        'heys_curator_panel_v1.js',
    ...
    'postboot-3-ui-lazy': [
        ...
        // Косвенный довод перестройки спрашивает рабочие веса — грузится раньше.
        'heys_working_weights_v1.js',
