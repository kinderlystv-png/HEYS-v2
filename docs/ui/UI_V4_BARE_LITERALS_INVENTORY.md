...
| ----- | --------------------------------------- | -------: | ---: |
| 1     | значение в точности равно роли набора   |  **383** | 17 % |
| 2     | янтарная лестница прежней системы       | **1593** | 69 % |
| 3     | своя переменная модуля с зашитым цветом |   **32** |  1 % |
| —     | вне трёх вёдер                          |  **286** | 12 % |

**Ожидание, что ведро 1 — основной объём, не подтвердилось.** Оно 17 %; основное
...
- **Вне трёх вёдер 286**, из них **44** — тон роли при другой прозрачности.
...
Список зон по нему дать нельзя — **1131 место из 1593 стоит в файлах, которых не
...
1593, то есть почти половину. `fingers.css` вместе с `drums-finger-trainer.css`
