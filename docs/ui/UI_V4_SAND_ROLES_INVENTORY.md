...
Всего мест: **471** в 13 модулях — пересчитано 1 сентября. Было 472: одну роль
снял разбор чек-ина, переведя фон пилюли-ответа на `--v4-bg` по новой строке
контракта.
...
модулях» — два независимых счёта сходились на 472, сейчас на 471.

**Итог пересчитан, разделы — нет.** Шапка выше говорит правду на вечер 31
августа: 472. Таблицы по файлам собраны днём, когда мест было 581, и с тех пор
несколько сессий переводили роли на общие — **числа внутри разделов читать как
верхнюю границу**. Ниже, у заголовка каждого файла, стоит его живой счёт; где он
