...
Всего мест: **463** в 13 модулях — пересчитано 1 сентября. Было 471: восемь мест
ушли при сведении затронутых зон на общие роли активного набора.
...
модулях» — два независимых счёта сходились на 471, сейчас на 463.
