...
_Команда HEYS достигла выдающихся результатов и создала современную, безопасную
и высокопроизводительную систему готовую к промышленному использованию._
