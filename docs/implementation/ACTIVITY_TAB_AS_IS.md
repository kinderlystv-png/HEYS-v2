...
80 кг → чип «95 ккал», попап по тапу в тот же чип → «158 ккал». Сама подписанная
формула `минуты × MET × вес × 0.0175 − 1` неверна ни для одного из двух
вариантов: «−1» относится к MET, а не к произведению.
