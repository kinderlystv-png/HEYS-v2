...
> **Статус:** реализация трёх игр начата. Commit, push и production build не
> выполняются.
...
- Color Trail: JS 39 426 B raw / 8 544 B gzip; CSS 6 445 B raw.
