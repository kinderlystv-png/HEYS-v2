...
- **Последнее обновление**: 2026-07-31 — документационная сверка статусов
  SEC-004 / SEC-024 / L6 с фактическим состоянием (evidence 2026-07-26). Полный
...
> Следующий `SEC-028`. Добавляй новые находки сюда; не переписывай существующие.
