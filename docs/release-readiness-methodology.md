...
| Architecture & Modularity     | Green/Yellow | Green/Yellow     | Док-drift `storage_audit_enforce` устранён 2026-07-31; прочее без изменений                                                                                                                              |
...
(1.10.7), Android/DayTab smoke (1.10.8) и support diagnostics card (1.10.9).
Документационный drift `storage_audit_enforce` (1.10.10) закрыт 2026-07-31.
