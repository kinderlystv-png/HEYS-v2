...
| Training Modules              | Green/Yellow | **Green**        | Mobility map зелёная; broad-glob прогон стабилен (983 теста, два прогона подряд 2026-07-31)                                                                                                              |
| Testing & QA                  | Yellow/Red   | **Green/Yellow** | `test:regressions` 87/87 2026-07-26; broad training прогон стабилен 2026-07-31; остаётся незакреплённый регулярный pack (1.10.5)                                                                         |
...
Открыты P1-пункты, статус которых ведётся в `22` § 1.10: регулярный pre-release
pack (1.10.5), Android/DayTab smoke (1.10.8) и support diagnostics card
(1.10.9). Закрыты 2026-07-31: data-loss/recovery smoke (1.10.4), broad training
isolation (1.10.7) и документационный drift `storage_audit_enforce` (1.10.10).
