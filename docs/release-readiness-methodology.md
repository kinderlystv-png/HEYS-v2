...
| P0: production-like data-loss smoke обязателен до первого клиента                            | **Актуально, открыто** (offline/reconnect, stale snapshot, concurrent tabs, corrupted LS, timeout/413)                                                                                                                                                                                                                      | `22` § 1.10.4                                                            |
