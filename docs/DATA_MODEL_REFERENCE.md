...
> Версия: 3.2.0 | Обновлено: 2025-12-09 | **156 умных советов** | **26 факторов инсулиновой волны** | **🌸 Трекинг цикла**
...
**Файл**: `heys_insulin_wave_v1.js` | **Версия**: 3.0.1 | **Факторов**: 26
...
### Факторы влияющие на длину волны (v3.0.1 — научный аудит)
...
| 5 | | Белок | 20г=+5%, 35г+=+10% | `PROTEIN_BONUS` | [Nuttall 1984](https://pubmed.ncbi.nlm.nih.gov/6389060/) | ✅ Высокая |
| 6 | | Клетчатка | 5г=+8%, 10г+=+18% | `FIBER_BONUS` | [Wolever 1991](https://pubmed.ncbi.nlm.nih.gov/1654354/) | ✅ Высокая |
| 7 | | Жидкая пища | ×0.82 (−18%) | `LIQUID_FOOD` | — | ⚠️ Эмпирика |
...
| 13 | **Активность** | Тренировка (общая) | 20мин=-8%, 45мин+=-15% (интенсивные ×1.5) | `WORKOUT_BONUS` | — | 📊 Средняя |
| 14 | | Постпрандиальная тренировка | 15мин=-10%, 20мин=-18%, 30мин+=-25% | `POSTPRANDIAL_EXERCISE` | [Colberg 2009](https://pubmed.ncbi.nlm.nih.gov/19560716/) | ✅ Высокая |
| 15 | | NEAT (бытовая активность) | 15мин=-2%, 30мин=-5%, 60мин+=-10% | `NEAT_BONUS` | [Hamilton 2007](https://pubmed.ncbi.nlm.nih.gov/17827399/) | ✅ Высокая |
| 16 | | Шаги | 2000=-2%, 5000=-4%, 8000+=-8% | `STEPS_BONUS` | — | ⚠️ Эмпирика |
| 17 | **Ритмы** | Циркадные ритмы | утро=×0.9, день×0.95-1.0, вечер=×1.1, ночь=×1.2 (ослаблены при GL<10) | `CIRCADIAN_MULTIPLIERS` | [Van Cauter 1997](https://pubmed.ncbi.nlm.nih.gov/9331550/) | ✅ Высокая |
| 18 | | Голодание (fasting) | 8ч=-5%, 12ч=-10%, 16ч+=-15% | `FASTING_BONUS` | [Sutton 2018](https://pubmed.ncbi.nlm.nih.gov/29754952/) | ✅ Высокая |
| 19 | **Состояние** | Стресс (шкала 1-10) | 5-6=+8%, 7-10=+15% | `STRESS_BONUS` | — | 📊 Cortisol-связь |
| 20 | | Недосып | 5-6ч=+8%, 4-5ч=+15%, <4ч=+20% | `SLEEP_BONUS` | [Spiegel 1999](https://pubmed.ncbi.nlm.nih.gov/10543671/) | ✅ Высокая |
| 21 | | Качество сна (1-10) | 1-4=+12%, 5-6=+6% | `SLEEP_QUALITY_BONUS` | [Tasali 2008](https://pubmed.ncbi.nlm.nih.gov/18172212/) | ✅ Высокая |
| 22 | | Гидратация | <30%=+12%, 30-50%=+8%, 50-70%=+4% | `HYDRATION_BONUS` | [Johnson 2017](https://pubmed.ncbi.nlm.nih.gov/28739050/) | 📊 Средняя |
| 23 | **Персональные** | Возраст | 30-44=+4%, 45-59=+8%, 60+=+15% | `AGE_BONUS` | [DeFronzo 1979](https://pubmed.ncbi.nlm.nih.gov/510806/) | ✅ Высокая |
| 24 | | BMI | 25-30=+10%, 30+=+20% | `BMI_BONUS` | [Kahn & Flier 2000](https://pubmed.ncbi.nlm.nih.gov/10953022/) | ✅ Высокая |
| 25 | | Пол | М=+5%, Ж=-5% | `GENDER_BONUS` | [Nuutila 1995](https://pubmed.ncbi.nlm.nih.gov/7813811/) | ✅ Высокая |
| 26 | | 🌸 Менструальный цикл | лютеиновая +8-10%, менструация +12-15% | `CYCLE_BONUS` | [Escalante 1999](https://pubmed.ncbi.nlm.nih.gov/10071420/) | ✅ Высокая |
...
### 5. Insulin Index (для молочных продуктов)

**Проблема**: Молочные продукты вызывают непропорционально высокий инсулиновый ответ (выше чем предсказывает GL).

| Тип продукта | II множитель | Эффект на GL |
|--------------|--------------|--------------|
| Жидкая молочка (молоко, йогурт) | ×3.0 | GL × 3.0 |
| Мягкая молочка (творог) | ×2.5 | GL × 2.5 |
| Твёрдая молочка (сыр) | ×1.5 | GL × 1.5 |
| Чистый белок (протеин) | ×1.8 | GL × 1.8 |
