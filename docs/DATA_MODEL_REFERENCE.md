...
> Версия: 5.0.0 | Обновлено: 2026-02-12 | **182 умных совета** | **37 факторов
...
> Extended Nutrients** | **🔮 Predictive Insights v5/v6: 41 паттерн (100%
> научное покрытие)**
...
## 🔮 Predictive Insights v5/v6 — 41 научный паттерн

> **Версия**: 5.0.0 | **Обновлено**: 2026-02-12 | **100% покрытие PMID** |
> **41/41 паттернов активны**  
> **Файлы**: `pi_patterns.js` (анализаторы), `pi_constants.js` (SCIENCE_INFO),
> `pi_ui_cards.js` (UI)  
> **Модули**: 2864 LOC patterns, 1336 LOC constants, 1648 LOC UI
