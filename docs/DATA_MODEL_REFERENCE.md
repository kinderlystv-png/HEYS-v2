...
| 33  | **B_COMPLEX_ANEMIA**        | 1     | NUTRITION  | B1-B12 + Fe           | 7       | 26828517, 29215971 |
| 34  | **GLYCEMIC_LOAD**           | 2     | TIMING     | GL per meal/day       | 5       | 12081850, 18835944 |
| 35  | **PROTEIN_DISTRIBUTION**    | 2     | NUTRITION  | 20-40г per meal       | 7       | 29497353, 19056590 |
| 36  | **ANTIOXIDANT_DEFENSE**     | 3     | NUTRITION  | A, C, E, Se, Zn       | 7       | 20096093, 12424324 |
| 37  | **ADDED_SUGAR_DEPENDENCY**  | 3     | NUTRITION  | <25г WHO              | 7       | 25231862, 22351714 |
| 38  | **BONE_HEALTH**             | 4     | METABOLISM | Ca, D, K, P           | 14      | 26856587, 21118827 |
| 39  | **TRAINING_TYPE_MATCH**     | 4     | ACTIVITY   | cardio/strength/hobby | 5       | 26891166, 29182451 |
| 40  | **ELECTROLYTE_HOMEOSTASIS** | 5     | METABOLISM | Na, K, Mg, Ca         | 7       | 28070459, 29480918 |
...
- **Nutrition** (35%): Meal Quality, Nutrition Quality, Protein, Fiber, Gut
  ...
  B-Complex (C33), Protein Distribution (C35), Antioxidants (C36), Sugar (C37),
  Nutrient Density (C41)
- **Timing** (20%): Meal Timing, Wave Overlap, Late Eating, Circadian, Nutrient
  Timing, Glycemic Load (C34)
- **Activity** (15%): Steps↔Weight, NEAT, Training↔Kcal, Training Recovery
  (C11), Training-Type Match (C39)
- **Recovery** (20%): Sleep Quality, Sleep↔Weight, Sleep↔Hunger, Hydration,
  Wellbeing, Cycle Impact, Antioxidants (C36), Bone Health (C38)
- **Metabolism** (10%): Insulin Sensitivity, Body Composition, Heart Health
  (C9), Hypertrophy (C12), Electrolytes (C40)

**Formula**: `Σ(category_avg × goal_weight) / Σ(weights)` → 0-100 score

**Goal adjustments**:

- Deficit → Nutrition 40%, Recovery 25%
- Maintenance → Recovery 25%, Metabolism 15%
- Surplus → Activity 20%, Recovery 25%
...
| `heys_advice_v1.js`                 | Модуль умных советов (182 совета)        |
...
| `heys_predictive_insights_v1.js`    | Прогнозы и паттерны                      |
