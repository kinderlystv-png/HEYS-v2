...
> Версия: 3.8.0 | Обновлено: 2025-12-11 | **168 умных советов** | **32 фактора
...
| `pre`              | ⚡ Перед трен.      | до −20%           | 1.0            | Еда ДО тренировки (до 90 мин)     |
...
| Tier | Gap         | waveBonus | harmMultiplier |
| ---- | ----------- | --------- | -------------- |
| 1    | 0-30 мин    | −40%      | 0.6            |
| 2    | 30-60 мин   | −30%      | 0.7            |
| 3    | 60-120 мин  | −20%      | 0.8            |
| 4    | 120-180 мин | −10%      | 0.9            |
| 5    | 180-360 мин | −5%       | 0.95           |

**Особенности**:

- `nightPenaltyOverride: true` — отменяет ночной штраф инсулиновой волны
- Интенсивные тренировки (high/extreme) дают бонус ×1.3-1.5 к waveBonus
...
**Окно эффекта**: 0-2 часа после еды (эффект линейно уменьшается по мере
удаления от приёма).
