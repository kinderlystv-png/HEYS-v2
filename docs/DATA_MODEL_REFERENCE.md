...
```javascript
HEYS.MetabolicIntelligence.getVariant(); // 'A' | 'B' | 'C'
HEYS.MetabolicIntelligence.setVariant(variant);
HEYS.MetabolicIntelligence.getDataInventory(historyDays);
HEYS.MetabolicIntelligence.getTier(daysCount);
```
