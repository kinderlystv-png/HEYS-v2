...
> Версия: 2.0.0 | Обновлено: 2025-12-08 | **156 умных советов** | **26 факторов инсулиновой волны** | **🌸 Трекинг цикла**
...
| 2 | | GL (гликемическая нагрузка) | veryLow=×0.7, low=×0.85, medium=×1.0, high=×1.2, veryHigh=×1.35 | `GL_CATEGORIES` | Brand-Miller 2003 |
| 3 | | Количество углеводов | < 5г = 25% волны, 30г+ = 100% | `CARBS_SCALING` | — |
| 4 | | Жиры | 8г=+10%, 15г=+20%, 25г+=+35% | `FAT_BONUS` | Liddle 1991 |
| 5 | | Белок | 20г=+10%, 35г+=+18% | `PROTEIN_BONUS` | Westphal 1990 |
...
### Изменения v2.0 (научный аудит)

**Скорректированные факторы:**
- GL: сужен диапазон ×0.7-1.35 (было ×0.5-1.25)
- Жиры: увеличен эффект +10-35% (было +8-30%)
- Белок: снижен порог 20г/35г (было 25г/40г), увеличен эффект +10-18%
- Клетчатка: увеличен эффект +8-18% (было +5-12%)
- Жидкая пища: уменьшен эффект ×0.82 (было ×0.7)
- Молочка: разделено на 3 категории (жидкие/мягкие/твёрдые)
- Острая пища: уменьшен эффект ×0.96 (было ×0.92)
- Кофеин: уменьшен эффект +6% (было +12%)
- **Голодание: ИНВЕРТИРОВАН ЗНАК** — теперь сокращает волну (повышенная чувствительность)
