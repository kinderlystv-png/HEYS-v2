...
> Версия: 3.0.0 | Обновлено: 2025-12-09 | **156 умных советов** | **26 факторов инсулиновой волны** | **🌸 Трекинг цикла**
...
### Факторы влияющие на длину волны (v2.1 — научный аудит)
...
| 2 | | GL (гликемическая нагрузка) | micro(GL<2)=×0.25, veryLow(2-5)=×0.40, low(5-10)=×0.55, medium=×1.0, high=×1.15, veryHigh=×1.25 | `GL_CATEGORIES` | Brand-Miller 2003 |
...
| 17 | **Ритмы** | Циркадные ритмы | утро=×0.9, день×0.95-1.0, вечер=×1.1, ночь=×1.2 (ослаблены при GL<10) | `CIRCADIAN_MULTIPLIERS` | Van Cauter 1997 |
