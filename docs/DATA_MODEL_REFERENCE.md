...
> Версия: 3.15.0 | Обновлено: 2025-12-12 | **169 умных советов** | **33 фактора
> инсулиновой волны** | **🏋️ Training Context** | **💰 Caloric Debt** | **🍽️ Refeed Day Marker**
...
Особый режим при критическом недоборе:

- **Триггеры**: долг ≥1000 ккал ИЛИ 5+ дней в дефиците >20% ИЛИ долг >500 +
  тренировка сегодня
- **Эффект**: +35% к норме вместо обычного распределения
- **Цель**: Предотвратить метаболическую адаптацию, поддержать гормональный фон
...
| ------ | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 3.15.0 | 2025-12-12 | **🍽️ Refeed Day Manual Marker**: Добавлено поле `isRefeedDay` в DayRecord (boolean\|null). Функциональность: шаг в утреннем чек-ине для отметки загрузочного дня, автоматическая рекомендация при `caloricDebt.needsRefeed`, визуальная индикация (refeed card с статусом ok/over), исключение refeed дней из weight trend, совет `refeed_day_reminder` с action button. **169 советов** (+1 refeed_day_reminder). Интеграция с caloric debt система для персонализированных рекомендаций загрузки при накоплении долга. |
