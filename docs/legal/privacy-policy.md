...
ИП Поплавский Антон Алексеевич  
ИНН: [ИНН]  
ОГРНИП: [ОГРНИП]  
Адрес: [Адрес]  
...
6.3.1. В случае использования зарубежных сервисов (CDN, email-провайдеры) мы:

- Передаём только обезличенные или минимально необходимые данные
- Уведомляем Роскомнадзор в порядке ст. 12 152-ФЗ до начала передачи
- Обеспечиваем адекватный уровень защиты данных
...
_Последнее обновление: 20 декабря 2025 г._
