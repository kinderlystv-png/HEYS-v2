...
| Backups                  | S3 `heys-backups/client-daily/...`                                  | 90 дней hot/cold baseline; longer archive только после legal sign-off                      | lifecycle policy или batch delete; watchdog `backup_chain_gap`                  | `backup_run_log`                |
