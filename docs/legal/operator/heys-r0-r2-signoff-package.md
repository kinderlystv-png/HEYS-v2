...
| DSAR owner/log/sign-off          | [heys-dsar-procedure-draft.md](heys-dsar-procedure-draft.md), [heys-dsar-request-log-template.md](heys-dsar-request-log-template.md), `export_my_data_by_session` | 🟡     | self-service RPC/UI + owner/template ready; legal sign-off + factual external log |
