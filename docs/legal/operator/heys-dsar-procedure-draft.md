...
1. Канал запроса R0: `poplanton@mail.ru` или Telegram/service chat, если
   identity можно подтвердить. Отдельный alias `privacy@heyslab.ru` включать
   только после создания и smoke доставки по
   [heys-privacy-intake-runbook.md](heys-privacy-intake-runbook.md).
...
| Нет отдельного privacy alias  | R0-intake идет через опубликованный `poplanton@mail.ru`; runbook готов    | создать alias, smoke доставки и legal-version bump              |
