...
> Версия: 5.4.0 | Обновлено: 2026-02-19 | **41 научный паттерн** | **25 типов
> предупреждений** | **32 достижения** | **6 фенотипов**
...
| ------ | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 5.4.0  | 2026-02-19 | **🚨 EWS v4.0→v4.2 + Dynamic Priority Badge v4.3.0**: Global Score, Causal Chains, Weekly Progress, Phenotype-Aware Thresholds, Acuteness Decay, Pattern Degradation Boost |
| 5.0.0  | 2026-02-12 | **🔮 HEYS Insights v5/v6 — 41 паттерн (100% PMID покрытие)**: Завершена работа над крупной аналитической системой с научными метриками                                     |
| 4.3.0  | 2026-01-18 | **🏭 NOVA Classification v1.0 + Extended Nutrients v3.0**: 4 группы переработки, 29 новых колонок в БД (витамины, минералы, флаги качества)                                |
| 4.2.0  | 2025-01-17 | **🧪 Harm Score v1.0.0**: Научная система оценки вредности продуктов 0-10 с PMID ссылками                                                                                  |
| 3.23.0 | 2025-12-21 | **📊 Analytics Documentation v1.0**: Добавлены 7 новых секций аналитических модулей (Status, Gamification, Phenotype, Metabolic Intelligence)                              |

---

**Версия документа**: 5.4.0 **Последнее обновление**: 2026-02-19
**Сохраняется**: GitHub (c:\Users\Ant\HEYS-v2\docs\DATA_MODEL_ANALYTICS.md)
