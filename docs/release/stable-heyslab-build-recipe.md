...
| Patches                             | `d75ec593d` readonly, `3d1904513` write-context RPC, `4a7ced768` consent gate |
...
git show d75ec593d:apps/web/index.html > apps/web/index.html
...
# consent / прочие stable-only патчи — подставить нужный commit:
git show 4a7ced768:apps/web/heys_app_gate_flow_v1.js > apps/web/heys_app_gate_flow_v1.js
git show 4a7ced768:apps/web/heys_consents_v1.js > apps/web/heys_consents_v1.js

# 2. Зависимости и бандлы (только затронутые файлы)
pnpm install --frozen-lockfile
pnpm bundle:legacy:auto --files=apps/web/heys_app_gate_flow_v1.js,apps/web/heys_consents_v1.js,apps/web/heys_yandex_api_v1.js,apps/web/heys_app_shell_v1.js,apps/web/index.html
