...
- [`ui/UI_V4_FINDINGS.md`](ui/UI_V4_FINDINGS.md) — журнал расхождений с
  контрактом: то, что нашлось при сведении экрана и меняет контракт, кадр или
  приёмочный лист. Владеет очередью вопросов к дизайнеру; дефекты кода, где
  контракт прав, туда не идут — они живут в протоколе своего экрана.
