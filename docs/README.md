...
- [`ui/handoff-v4`](ui/handoff-v4/README.md) — дизайн-пакет v4 от 2026-08-09:
  ...
  выше.
- [`ui/verdicts/<зона>.json`](ui/verdicts/<зона>.json) — вердикт по каждой
  строке контракта плюс отпечаток её значения на момент разбора. Владеет
  приёмкой: файлы `ACCEPTANCE*.md` в пакете дизайна — снимок 20.08, живая
  проверка — `pnpm ui:v4:check`.
