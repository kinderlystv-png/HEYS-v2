...
- [`ui/prompts/БРИФ-планируемые-приёмы.md`](ui/prompts/%D0%91%D0%A0%D0%98%D0%A4-%D0%BF%D0%BB%D0%B0%D0%BD%D0%B8%D1%80%D1%83%D0%B5%D0%BC%D1%8B%D0%B5-%D0%BF%D1%80%D0%B8%D1%91%D0%BC%D1%8B.md)
  — бриф на прототип новой сущности «запланированный приём» и прогноза дня во
  вкладке «Питание». Основной автор набросков — куратор через коннектор, поэтому
  бриф захватывает и лист правок куратора. Границы (план не трогает факт),
  подводные камни из аудита кода, кадры, строки контракта, открытые вопросы.
  Владеет постановкой задачи до появления канваса; как только канвас приедет —
  правду по числам забирает он.
