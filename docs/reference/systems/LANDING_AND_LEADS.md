...
> **Статус:** source-контракты проверены 2026-07-27 **Охват:** формы заявки,
> согласия, gateway, сохранение и дедупликация, атрибуция, Telegram-уведомление
> и передача лида в curator flow **Не подтверждено:** production
> deployment/runtime, доставка Telegram и Метрики, фактическая обработка заявок
> командой
