...
незакрытые подходы не участвуют в историческом рекорде. Рабочий прогресс
`doneApproaches / totalApproaches` и счётчик незакрытых не включают разминочные
подходы; их число ведётся отдельно в `warmupApproaches`. Процент к прошлой
