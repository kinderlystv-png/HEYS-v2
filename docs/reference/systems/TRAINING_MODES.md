...
> **Статус:** source architecture проверена 2026-07-18<br> **Охват:**
> TrainingKernel/TrainingFocus, bundle boundary, fingers и mobility, session
> lifecycle, persistence, diary integration, tests и methodology maps<br> **Не
...
| TR3  | Оба режима имеют lazy boot stub и отдельный ready event                                | `rg -n -e 'BUNDLE_FILE' -e 'READY_EVENT' apps/web/heys_fingers_boot_stub_v1.js apps/web/heys_mobility_boot_stub_v1.js`                                                                                                                                                                                                                                                                                                                      | проверено 2026-07-17                                     |
