        ...
        try {
            ...
            (data || []).forEach(row => {
                try {
                    ...
                    let local = null;
                    try {
                        local = JSON.parse(ls.getItem(key));
                    }
                    catch (e) { }
...
//# sourceMappingURL=heys_storage_supabase_v1_backup.js.map