...
(function (global) {
    ...
    function ensureDay(d, prof) {
        ...
        trainings = trainings.map((t) => (t && Array.isArray(t.z)) ?
    ...
    function buildProductIndex(ps) {
        ...
        (ps || []).forEach((p) => {
            ...
            if (id != null)
                byId.set(String(id).toLowerCase(), p);
    ...
    function getProductFromItem(it, idx) {
        ...
        if (it.product_id != null)
            return idx.byId.get(String(it.product_id).toLowerCase()) || null;
        if (it.productId != null)
            return idx.byId.get(String(it.productId).toLowerCase()) || null;
    ...
    function mealTotals(meal, idx) {
        ...
        if (_mealTotalsCache.has(key))
            return _mealTotalsCache.get(key);
        const T = { kcal: 0, carbs: 0, simple: 0, complex: 0, prot: 0, protein: 0, fat: 0, bad: 0, good: 0, trans: 0, fiber: 0 };
...
export {};
//# sourceMappingURL=heys_models_v1.js.map