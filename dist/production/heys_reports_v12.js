...
;(function(global){
  ...
  HEYS.ReportTab = function ReportsTab(props){
  ...
  // Инициализируем систему инвалидации кэша при загрузке модуля
  if (typeof window !== 'undefined') {
    // Задержка для того, чтобы другие модули успели загрузиться
