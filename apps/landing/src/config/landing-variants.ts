    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'Первый контакт проходит в выбранном при заявке канале. После входа можно продолжить общение во встроенном мессенджере HEYS — так переписка, дневник и контекст остаются рядом.\n\nКуратор на связи ежедневно, 09:00–21:00 по московскому времени, включая выходные. Ориентир ответа и внесения данных в дневник — 1–2 часа, но это не гарантированный срок: полный разбор может занять больше времени. Отдельное приложение устанавливать не обязательно.',
        },
        {
