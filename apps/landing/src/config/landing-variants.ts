...
export const VARIANTS: Record<LandingVariant, VariantContent> = {
  ...
  A: {
    ...
    hero: {
      ...
      subheadline: 'Куратор каждый день смотрит в ваш дневник, разбирает причины и пишет первым, когда видит что что-то идёт не так. Не один на один с задачей.',
      features: [],
      ...
      cards: [
        {
          ...
          desc: 'Дневник вы ведёте сами в приложении, а куратор раз в неделю смотрит данные и даёт объективное ревью.',
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'HEYS использует метаболическое моделирование и оценивает 37 параметров по вашему дневному отчёту (сон, питание, пульс, уровень стресса и др.). Алгоритм Crash Risk Score (CRS) находит скрытый паттерн накопившейся усталости за 2-3 дня до того, как вы попадёте в метаболическую «яму», и заранее адаптирует план.',
        },
        {
