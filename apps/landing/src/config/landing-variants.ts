...
export const VARIANTS: Record<LandingVariant, VariantContent> = {
  ...
  A: {
    ...
    hero: {
      ...
      subheadline: 'Куратор ведёт ваш дневник по присланным данным, видит паттерны недели и помогает спокойно вернуться в режим, когда он сбивается.',
      features: [],
    ...
    formats: {
      ...
      cards: [
        ...
        },
        {
          ...
          desc: 'Куратор ведёт ваш дневник, видит контекст недели и помогает удерживать ритм без стыда. В Pro+ дополнительно — больше внимания к тренировкам.',
          points: [
            'Подходит, если вы устали срываться и бросать',
            'Нужен живой человек в контуре и меньше рутины',
            'В Pro+ — больше ручного внимания к тренировкам',
          ],
          highlight: true,
        },
      ],
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'В Pro подсчёты и внесение дневника берёт на себя куратор. Вам нужно прислать фото еды на весах или короткое сообщение с порцией: так данные в дневнике становятся точнее, а разбор недели — полезнее.\n\nЭто занимает несколько секунд: поставили тарелку на весы → сделали фото → отправили куратору. Никаких таблиц и ручных подсчётов.',
        },
        {
        ...
        },
        {
          ...
          a: 'HEYS разбирает дневник по 41 паттерну питания и состояния: сон, режим, активность, стресс и повторяющиеся сценарии недели. Это помогает раньше увидеть накопившуюся усталость, пропуски еды или сдвиги в режиме и выбрать простой следующий шаг.',
        },
        {
