  ...
  return (
    <section id="reviewed-week" className="bg-slate-50 px-5 py-14 sm:px-8 sm:py-16">
      <div className="mx-auto w-full max-w-xl">
        ...
        {/* Ответ на возражение «пробовал приложения и бросил» переехал сюда из
            блока узнавания, где он гасил эмоциональный пик. Здесь он на месте:
            стоит прямо перед механикой, которая его и показывает. */}
        <p className="mt-3 text-[15px] leading-6 text-slate-600">
          Считать и заносить не нужно. На выходе — не один неидеальный день, а изменения за неделю и
          один выполнимый шаг дальше.
        </p>
        ...
        {/* Абзац «решение принимает куратор» убран: та же мысль теперь стоит
            строкой стандарта ведения в первом слое над тарифами, а внутри
            артефакта её показывает узел «что уточнил куратор». Повтор одного
            аргумента трижды на полутора экранах запрещён `COPY_VOICE`. */}
      </div>
    </section>
  );
}
