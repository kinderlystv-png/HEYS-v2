...
const FLOW = [
  ...
  // Уточнение живёт внутри шага куратора, а не отдельным четвёртым шагом:
  // отдельный шаг обещал бы формальную стадию опроса, которой в работе нет, и
  // добавил бы блоку строку при и без того выросшей высоте. Заголовок секции
  // обещает разобранную неделю — значит, в механике должно быть видно, что
  // куратор спрашивает, а не только заносит.
  {
    step: '02',
    title: 'Куратор ведёт дневник и уточняет',
    text: 'Заносит еду, сон и нагрузку, а если день выбился — спрашивает, что происходило.',
  },
  {
    step: '03',
