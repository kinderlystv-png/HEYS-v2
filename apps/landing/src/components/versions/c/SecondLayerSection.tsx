...
// Блок отвечает на «чем это не трекер», поэтому отличие должно стоять на том,
// чего у трекера нет в принципе. Раньше строка HEYS называла отличием ведение
// дневника человеком — но это снятая рутина, и её воспроизводит любой сервис с
// ассистентом. Ось сравнения переведена на уточнение контекста: трекер и
// консультация не спрашивают, что происходило в конкретные дни.
const COMPARISON = [
  {
    title: 'Трекер',
    text: 'Дневник заполняете сами, а почему вечер сбился — он не спросит и не объяснит.',
  },
  {
    title: 'Консультация',
  ...
  {
    title: 'HEYS',
    text: 'Куратор ведёт дневник, уточняет, что происходило в трудные дни, и предлагает следующий шаг уже с этим знанием.',
  },
];
