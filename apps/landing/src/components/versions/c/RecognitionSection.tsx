  ...
  return (
    <section id="recognition" className="bg-white px-5 py-14 sm:px-8 sm:py-16">
      <div className="mx-auto w-full max-w-xl">
        ...
        {/* Блок заканчивается на эмоции и ничем её не гасит. Раньше сразу под
            этой строкой стоял операционный ответ «считать и заносить не нужно»
            — самый сильный текст страницы обрывался технической сноской через
            одну строку. Ответ на возражение про брошенные приложения никуда не
            делся: он открывает следующий блок, то есть отделён половиной
            экрана, а не двумя с половиной. */}
