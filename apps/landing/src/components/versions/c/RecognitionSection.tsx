  ...
  return (
    <section id="recognition" className="bg-white px-5 py-14 sm:px-8 sm:py-16">
      <div className="mx-auto w-full max-w-xl">
        ...
        {/* Последняя ситуация в списке — про брошенные приложения. Оставлять её
            без ответа до второго слоя значит держать возражение открытым два с
            половиной экрана. Отвечаем коротко здесь; полное сравнение форматов
            остаётся единственным на странице и живёт в блоке «подробности». */}
        <p className="mt-3 text-[15px] leading-6 text-slate-600">
          Считать и заносить здесь не нужно: дневник ведёт куратор по тому, что вы присылаете.
        </p>
      </div>
    </section>
  );
