...
const ALSO_SEEN = [
  'Вода: в дни с поздним ужином её было заметно меньше — это усиливает вечерний голод.',
  'Шаги в четверг и пятницу упали вдвое: день был кабинетный, а не «ленивый».',
  'Выходные прошли ровно — значит дело в буднях и графике, а не в питании вообще.',
];

const NOT_A_GOOD_WEEK = [
  {
    title: 'Был избыток',
    text: 'Смотрим, в какие дни и из-за чего, и возвращаем режим со следующего приёма пищи. Компенсировать голоданием не предлагаем.',
  },
  {
    title: 'Был дефицит',
    text: 'Проверяем, не пропускались ли приёмы пищи из-за графика. Недобор — тоже сбой ритма, а не «хорошая неделя».',
  },
  {
    title: 'Праздник или ужин вне дома',
    text: 'Считаем это частью обычной жизни. Задача — вернуться в ритм назавтра, а не «отработать» съеденное.',
  },
];
