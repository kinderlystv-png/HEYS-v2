...
const objections = [
    {
        ...
        answer:
            'Вносить — не вам. Вы присылаете фото еды на весах, короткое сообщение или голосовое. Дальше куратор переносит данные в дневник, фиксирует тренировки и активность, добавляет новые продукты в вашу базу. На вас остаётся простой чек-ин и контекст, который важен для разбора.',
    },
    {
    ...
    },
    {
        ...
        answer:
            'Куратор учитывает ваш график заранее: перелёт, смену часовых поясов, питание в отелях. Если часто не получается нормально пообедать, заранее подбираем простые варианты перекуса и запасной план. График подстраивается под вашу жизнь, а не наоборот.',
    },
    {
        question: 'Чем HEYS отличается от консультации нутрициолога или тренера?',
        answer:
