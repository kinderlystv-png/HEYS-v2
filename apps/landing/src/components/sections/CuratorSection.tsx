...
const cards = [
    ...
    },
    {
        ...
        text: 'Куратор остаётся с вами всё время подписки: смотрит дневник каждый день, разбирает прогрессию раз в неделю, пишет первым когда замечает что что-то идёт не так. Первая неделя — погружение в ваш контекст.',
    },
    {
        icon: '🤝',
    ...
    },
    {
        icon: '🧭',
        title: 'Без давления',
        text: 'Не пишет каждый день, не упрекает за пропуски. Вы решаете когда обратиться.',
    },
]
            ...
            <div className="mx-auto w-full max-w-[1024px] px-4 md:px-6">
                ...
                >
                    ...
                    <p className="text-[15px] sm:text-[17px] text-[#6b7280] leading-relaxed">
                        Не бот, не FAQ. Живой куратор на связи с первого дня — в удобном вам мессенджере.
                    </p>
                </div>
                    ...
                    <div className="bg-gray-50/60 border border-gray-100 rounded-3xl p-4 sm:p-5 space-y-3">
                        ...
                        <div className="flex justify-end">
                            <div className="bg-blue-600 text-white text-[14px] sm:text-[15px] rounded-2xl rounded-br-md px-4 py-2.5 max-w-[80%] leading-snug shadow-sm">
                                Опять сорвался вечером, заглушил вином 😔
                            </div>
                        </div>
                        {/* Curator bubble (left) */}
                        <div className="flex justify-start">
                            <div className="bg-white text-[#111827] text-[14px] sm:text-[15px] rounded-2xl rounded-bl-md px-4 py-2.5 max-w-[92%] sm:max-w-[85%] leading-snug shadow-sm border border-gray-100">
                                Видел в дневнике — 3 дня недобор по белку. Это не «безволие», это мозг просит калории. Не вино виновато. Завтра можно +50г творога за обедом — проверим эффект.
                            </div>
                        </div>
