...
| Account deletion entry point is not the privacy policy fallback.                                                                 | local files       | `rg -n "accountDeletionUrl" apps/mobile/app.json`; `rg -n "ACCOUNT_DELETION_URL" apps/mobile/src/shared/config/urls.ts`; `test -f apps/web/public/docs/account-deletion.md && echo exists`                                                                                     | Confirmed: mobile config points to dedicated account deletion instructions.                                                                                                  |
