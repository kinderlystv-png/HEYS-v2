...
| Push is not active in the first iOS release.                                                                                     | local files       | `rg -n "expo-notifications" apps/mobile/package.json apps/mobile/app/settings/index.tsx apps/mobile/src -g '!node_modules'`                                                                                    | Confirmed: no active package dependency, import or permission request remains.                                                                                               |
