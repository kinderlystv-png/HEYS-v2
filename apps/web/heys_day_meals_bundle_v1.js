                ...
                return React.createElement('div', {
                    ...
                    React.createElement('div', { className: 'metric-popup-content', style: { padding: '12px' } },
                        ...
                        React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' } },
                            ...
                            React.createElement('div', { style: { flex: 1, height: '6px', background: 'var(--border, #e5e7eb)', borderRadius: '3px', overflow: 'hidden' } },
                        ...
                        (quality.badges && quality.badges.length > 0) && React.createElement('div', {
                            ...
                            quality.badges.slice(0, 4).map((badge, i) => {
                                ...
                                return React.createElement('span', {
                                    key: i,
                                    style: {
                                        background: isPositive ? 'var(--wellbeing-badge-bg, #dcfce7)' : 'rgba(248, 113, 113, 0.15)',
                                        color: isPositive ? 'var(--wellbeing-badge-color, #166534)' : '#f87171',
                                        padding: '2px 6px',
                                        borderRadius: '8px',
                                        fontSize: '10px',
                                        fontWeight: 500,
    ...
    async function showMultiProductSummary({
        ...
        const ProductsList = mealItems.length > 0 ? React.createElement('div', {
            ...
            mealItems.slice(0, 6).map((item, idx) =>
                React.createElement('div', {
                    ...
                    style: {
                        ...
                        alignItems: 'center',
                        padding: '3px 0',
                        borderBottom: idx < Math.min(mealItems.length, 6) - 1 ? '1px dotted var(--border, #e2e8f0)' : 'none'
                    }
                },
                    React.createElement('span', { style: { color: 'var(--text, #334155)' } },
                        item.name,
                        ' ',
                        React.createElement('span', { style: { color: 'var(--muted, #94a3b8)', fontSize: '11px' } }, item.grams + 'г')
                    ),
                    React.createElement('span', {
                        style: { fontWeight: '600', color: 'var(--text, #475569)', minWidth: '45px', textAlign: 'right' }
                    }, item.kcal)
                )
            ),
            mealItems.length > 6 && React.createElement('div', {
                style: { fontSize: '11px', color: 'var(--muted, #94a3b8)', marginTop: '4px', textAlign: 'center' }
            ...
            React.createElement('div', {
                ...
                React.createElement('span', { style: { color: 'var(--text, #334155)' } }, 'Итого'),
        ...
        return React.createElement('div', { className: mealCardClass, 'data-meal-index': mealIndex, style: mealCardStyle },
            ...
            React.createElement('div', { className: 'mobile-products-list' },
                ...
                isExpanded && (meal.items || []).map((it) => {
                    ...
                    const getHarmBg = (h) => {
                        if (h == null) return isDark ? '#334155' : '#fff';
                        if (isDark) {
                            if (h <= 1) return '#065f46';
                            if (h <= 2) return '#064e3b';
                            if (h <= 3) return '#1a3a2e';
                            if (h <= 4) return '#1f3a2c';
                            if (h <= 5) return '#1e3a5f';
                            if (h <= 6) return '#1e3450';
                            if (h <= 7) return '#4a2020';
                            if (h <= 8) return '#5a2525';
                            if (h <= 9) return '#6a2030';
                            return '#7f1d1d';
                        }
                ...
                showWaveButton && React.createElement('div', {
                    ...
                    (() => {
                        ...
                        return React.createElement('div', {
                            ...
                            React.createElement('div', { style: { fontSize: '11px', color: 'var(--muted, #64748b)' } },
                                inRiskWindow
                ...
                React.createElement('div', {
                            ...
                            hasRatings ? React.createElement(React.Fragment, null,
                                moodEmoji && React.createElement('div', {
                                    style: {
                                        ...
                                        padding: '2px 6px',
                                        borderRadius: '8px',
                                        background: 'var(--mood-badge-bg, #fef3c7)',
                                        minWidth: '28px',
                                    },
                                },
                                    React.createElement('span', { style: { fontSize: '12px' } }, moodEmoji),
                                    React.createElement('span', { style: { fontSize: '11px', fontWeight: 600, color: 'var(--mood-badge-color, #b45309)' } }, moodVal),
                                ),
                                wellbeingEmoji && React.createElement('div', {
                                    style: {
                                        ...
                                        padding: '2px 6px',
                                        borderRadius: '8px',
                                        background: 'var(--wellbeing-badge-bg, #dcfce7)',
                                        minWidth: '28px',
                                    },
                                },
                                    React.createElement('span', { style: { fontSize: '12px' } }, wellbeingEmoji),
                                    React.createElement('span', { style: { fontSize: '11px', fontWeight: 600, color: 'var(--wellbeing-badge-color, #15803d)' } }, wellbeingVal),
                                ),
                                stressEmoji && React.createElement('div', {
                                    style: {
                                        ...
                                        padding: '2px 6px',
                                        borderRadius: '8px',
                                        background: 'var(--stress-badge-bg, #fce7f3)',
                                        minWidth: '28px',
                                    },
                                },
                                    React.createElement('span', { style: { fontSize: '12px' } }, stressEmoji),
                                    React.createElement('span', { style: { fontSize: '11px', fontWeight: 600, color: 'var(--stress-badge-color, #be185d)' } }, stressVal),
                                ),
                            ) : React.createElement('span', {
                                style: {
                                    fontSize: '11px',
                    ...
                    (meal.items || []).length > 0 && React.createElement('button', {
                        ...
                        style: {
                            ...
                            borderRadius: '12px',
                            border: 'none',
                            background: 'var(--info-badge-bg, #dbeafe)',
                            color: 'var(--info-badge-color, #1d4ed8)',
                            fontSize: '12px',
                            fontWeight: 600,
                            cursor: 'pointer',
                            marginRight: '4px',
                    ...
                    optimizerRecsCount > 0 && React.createElement('button', {
                        ...
                        style: {
                            ...
                            borderRadius: '12px',
                            border: 'none',
                            background: 'var(--warning-badge-bg, #fef3c7)',
                            color: 'var(--warning-badge-color, #b45309)',
                            fontSize: '12px',
                            fontWeight: 600,
                            cursor: 'pointer',
                            marginRight: '4px',
                ...
                showWaveCalcPopup && currentWave && React.createElement('div', {
                    ...
                    React.createElement('div', {
                        ...
                        React.createElement('div', {
                            ...
                            React.createElement('button', {
                                ...
                                style: {
                                    ...
                                    cursor: 'pointer', color: 'var(--muted, #9ca3af)', padding: '4px',
                                },
                            }, '×'),
                        ),
                        ...
                        React.createElement('div', { style: { marginBottom: '12px' } },
                            ...
                            React.createElement('div', { style: { display: 'flex', justifyContent: 'space-between', fontSize: '12px', padding: '4px 0', borderBottom: '1px solid var(--border, #f1f5f9)' } },
                                React.createElement('span', { style: { color: 'var(--muted, #64748b)' } }, 'ГИ'),
                                React.createElement('span', { style: { fontWeight: 500 } }, Math.round(currentWave.gi || 0)),
                            ),
                            React.createElement('div', { style: { display: 'flex', justifyContent: 'space-between', fontSize: '12px', padding: '4px 0', borderBottom: '1px solid var(--border, #f1f5f9)' } },
                                React.createElement('span', { style: { color: 'var(--muted, #64748b)' } }, 'GL (нагрузка)'),
                            ...
                            React.createElement('div', { style: { display: 'flex', justifyContent: 'space-between', fontSize: '12px', padding: '4px 0', borderBottom: '1px solid var(--border, #f1f5f9)' } },
                                React.createElement('span', { style: { color: 'var(--muted, #64748b)' } }, 'Белок'),
                                React.createElement('span', { style: { fontWeight: 500 } }, Math.round(currentWave.protein || 0) + 'г'),
                            ),
                            React.createElement('div', { style: { display: 'flex', justifyContent: 'space-between', fontSize: '12px', padding: '4px 0', borderBottom: '1px solid var(--border, #f1f5f9)' } },
                                React.createElement('span', { style: { color: 'var(--muted, #64748b)' } }, 'Клетчатка'),
                            ...
                            React.createElement('div', { style: { display: 'flex', justifyContent: 'space-between', fontSize: '12px', padding: '4px 0', borderBottom: '1px solid var(--border, #f1f5f9)' } },
                                React.createElement('span', { style: { color: 'var(--muted, #64748b)' } }, 'Жиры'),
                            ...
                            React.createElement('div', { style: { display: 'flex', justifyContent: 'space-between', fontSize: '12px', padding: '4px 0' } },
                                React.createElement('span', { style: { color: 'var(--muted, #64748b)' } }, 'Углеводы'),
                        ...
                        React.createElement('div', { style: { marginBottom: '12px' } },
                            ...
                            React.createElement('div', { style: { display: 'flex', justifyContent: 'space-between', fontSize: '12px', padding: '4px 0', borderBottom: '1px solid var(--border, #f1f5f9)' } },
                                React.createElement('span', { style: { color: 'var(--muted, #64748b)' } }, 'Время суток'),
