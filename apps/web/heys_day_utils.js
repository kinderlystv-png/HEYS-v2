...
; (function (global) {
    ...
    const MEAL_TYPES = {
        ...
        // Кофе с молоком и сиропом — это не перекус: еды в нём нет, а в
        // дневнике он занимал строку наравне с тарелкой каши. Тип ставит
        // коннектор при записи (lib/day.js), автоопределение по времени его
        // не выдаёт — по времени такой приём неотличим от обычного перекуса.
