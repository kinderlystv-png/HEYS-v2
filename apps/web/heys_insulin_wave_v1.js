...
(function(global) {
  ...
  // Реальный эффект ~15-20%, не 30%
  const LIQUID_FOOD = {
    multiplier: 0.82,  // Жидкое усваивается на ~18% быстрее
  ...
  // 👴 AGE — с возрастом инсулиновая чувствительность снижается
  // DeFronzo (1979): каждые 10 лет = -7-8% чувствительности
  const AGE_BONUS = {
    elderly: { minAge: 60, bonus: 0.15 },   // 60+ лет → +15%
    middle: { minAge: 45, bonus: 0.08 },    // 45-59 → +8%
    adult: { minAge: 30, bonus: 0.04 },     // 30-44 → +4%
