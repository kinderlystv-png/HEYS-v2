        ...
        : React.createElement('div', { style: { display: 'flex', gap: 8 } },
          React.createElement('div', { style: { flex: 1, background: '#efe3cf', borderRadius: 16, padding: '12px 14px' } },
            ...
            React.createElement('div', { style: { display: 'flex', alignItems: 'baseline', gap: 6, marginTop: 6 } },
              ...
              // Строка «желаемый вес», решение 31 августа: тревожный тон --ac2
              // только у НЕДОСТАТКА веса, всё остальное — приглушённые чернила.
              // Кадр «Регистрация · рост и вес» красит им и «избыток», и он
              // перекрашивается: на третьем шаге регистрации человек ещё не
              // вошёл в продукт, и сказать ему тоном тревоги, что с ним что-то
              // не так, — не то, ради чего этот шаг стоит. «Ожирение» строка не
              // называет, но «только у недостатка» исключает и его — тем более
              // что к нему довод о тоне тревоги относится сильнее всего.
              React.createElement('span', {
                style: {
                  fontSize: 10.5,
                  fontWeight: 600,
                  lineHeight: 1,
                  color: bmiWord === 'недостаток' ? '#a1471c' : 'rgba(0,0,0,.45)',
                }
              }, bmiWord)
            )
          ),
