...
(function (global) {
  ...
  function ensureBar() {
    ...
    barEl.innerHTML = [
      ...
      '      <circle cx="15" cy="15" r="12.5" fill="none" stroke="var(--v4-act-text, #8a4a20)" stroke-opacity=".22" stroke-width="2.5"/>',
      '      <circle class="heys-undo-bar__arc" cx="15" cy="15" r="12.5" fill="none" stroke="var(--v4-act-text, #8a4a20)" stroke-width="2.5" stroke-linecap="round" transform="rotate(-90 15 15)"/>',
      '    </svg>',
