...
(function (global) {
  ...
  const SCIENCE_INFO = {
    ...
    STshort: 'Показывает, какие факторы увеличивают риск срыва и насколько. Цветовой индикатор показывает уровень опасности.',
    ...
    // === NEW v4.0 PATTERNS (B1-B6 + C2/C4/C6) ===
    SLEEP_QUALITY: {
  ...
  global.piScience = SCIENCE_INFO; // Fallback
