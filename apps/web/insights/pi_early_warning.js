...
(function (global) {
    ...
    function detectEarlyWarnings(days, profile, pIndex, options = {}) {
        ...
        console.log('[EWS] 🎯 Running 15 warning checks (5 baseline + 3 Tier 1 + 4 Tier 2 + 3 Tier 3)...');
        ...
        if (weightWarning) {
            console.log('[EWS]   ✅ Check 6 (WeightSpike): found warning');
            warnings.push(weightWarning);
        } else {
            console.log('[EWS]   ➖ Check 6 (WeightSpike): no warning');
        }

        // Warning 7: Hydration deficit
        const hydrationWarning = checkHydrationDeficit(days, profile);
        if (hydrationWarning) {
            console.log('[EWS]   ✅ Check 7 (Hydration): found warning');
            warnings.push(hydrationWarning);
        } else {
            console.log('[EWS]   ➖ Check 7 (Hydration): no warning');
        }

        // Warning 8: Logging gap
        const loggingWarning = checkLoggingGap(days, profile);
        if (loggingWarning) {
            console.log('[EWS]   ✅ Check 8 (LoggingGap): found warning');
            warnings.push(loggingWarning);
        } else {
            console.log('[EWS]   ➖ Check 8 (LoggingGap): no warning');
        }
        ...
        if (proteinWarning) {
            console.log('[EWS]   ✅ Check 9 (ProteinDeficit): found warning');
            warnings.push(proteinWarning);
        } else {
            console.log('[EWS]   ➖ Check 9 (ProteinDeficit): no warning');
        }

        // Warning 10: Stress accumulation
        const stressWarning = checkStressAccumulation(days, profile);
        if (stressWarning) {
            console.log('[EWS]   ✅ Check 10 (Stress): found warning');
            warnings.push(stressWarning);
        } else {
            console.log('[EWS]   ➖ Check 10 (Stress): no warning');
        }

        // Warning 11: Meal skip pattern
        const mealSkipWarning = checkMealSkipPattern(days, profile);
        if (mealSkipWarning) {
            console.log('[EWS]   ✅ Check 11 (MealSkip): found warning');
            warnings.push(mealSkipWarning);
        } else {
            console.log('[EWS]   ➖ Check 11 (MealSkip): no warning');
        }

        // Warning 12: Binge risk
        const bingeWarning = checkBingeRisk(days, profile, pIndex);
        if (bingeWarning) {
            console.log('[EWS]   ✅ Check 12 (BingeRisk): found warning');
            warnings.push(bingeWarning);
        } else {
            console.log('[EWS]   ➖ Check 12 (BingeRisk): no warning');
        }
        ...
        if (moodWarning) {
            console.log('[EWS]   ✅ Check 13 (MoodDecline): found warning');
            warnings.push(moodWarning);
        } else {
            console.log('[EWS]   ➖ Check 13 (MoodDecline): no warning');
        }

        // Warning 14: Weight plateau
        const plateauWarning = checkWeightPlateau(days, profile);
        if (plateauWarning) {
            console.log('[EWS]   ✅ Check 14 (WeightPlateau): found warning');
            warnings.push(plateauWarning);
        } else {
            console.log('[EWS]   ➖ Check 14 (WeightPlateau): no warning');
        }

        // Warning 15: Weekend pattern
        const weekendWarning = checkWeekendPattern(days, profile, pIndex);
        if (weekendWarning) {
            console.log('[EWS]   ✅ Check 15 (WeekendPattern): found warning');
            warnings.push(weekendWarning);
        } else {
            console.log('[EWS]   ➖ Check 15 (WeekendPattern): no warning');
        }
    ...
    console.log('[HEYS.InsightsPI] ✅ Early Warning System v3.0 loaded (15 checks: 5 baseline + 3 Tier 1 + 4 Tier 2 + 3 Tier 3)');
