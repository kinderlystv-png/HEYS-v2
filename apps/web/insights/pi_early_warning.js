...
(function (global) {
    ...
    const PATTERN_HUMAN_MESSAGES = {
        ...
        'meal_timing': {
            ...
            message: 'Интервалы между приёмами пищи отличаются от вашего обычного ритма',
            insight: 'Частоту питания выбирайте по голоду, самочувствию, медицинским ограничениям и способности соблюдать рацион.',
            science: 'Оценочные интервалы описывают время и состав приёмов, но не измеряют уровень инсулина и не задают обязательную частоту питания. Для снижения жировой массы важнее долгосрочный энергетический баланс и тренд веса.'
        },
        'wave_overlap': {
            title: 'Короткие интервалы между едой',
            message: 'Следующий приём часто добавляется до завершения оценки предыдущего',
            insight: 'Пересечение описывает частоту и состав приёмов пищи. Само по себе оно не показывает набор или снижение жировой массы.',
            science: 'Отклик — эвристическая оценка по составу еды, а не измерение гормонов. Оценивайте результат по долгосрочному тренду веса и энергетического баланса, а частоту питания — по голоду, самочувствию и соблюдаемости плана.'
        },
        'late_eating': {
    ...
    const WARNING_HUMAN_MESSAGES = {
        HEALTH_SCORE_DECLINE: {
            ...
            message: 'Общая оценка снижается третий день подряд. Так обычно выглядит накопленная усталость, а не один трудный день.',
        ...
        STATUS_SCORE_DECLINE: {
            ...
            message: 'Оценка дня падает несколько дней подряд. Обычно это значит, что восстановление отстаёт от нагрузки.',
        ...
        WEIGHT_SPIKE: {
            ...
            message: 'Вес прибавил больше килограмма за пару дней. Чаще всего это вода после солёного или позднего ужина, а не жир.',
        ...
        LOGGING_GAP: {
            ...
            message: 'Питание не записано два дня. Без записей выводы за период считаются по неполным данным.',
        ...
        PROTEIN_DEFICIT: {
            title: 'Дефицит белка',
            message: 'Белка меньше нормы третий день подряд. В такие дни сильнее тянет на сладкое, а восстановление после нагрузки идёт медленнее.',
        ...
        STRESS_ACCUMULATION: {
            ...
            message: 'Стресс держится высоким несколько дней без спокойных промежутков. После таких дней у вас обычно вечерний перебор.',
        ...
        MEAL_SKIP_PATTERN: {
            ...
            message: 'Приёмы пищи пропускаются регулярно. После длинного перерыва порция обычно выходит больше запланированной.',
        ...
        BINGE_RISK: {
            ...
            message: 'После долгих перерывов появляются очень большие порции. Помогает не выдерживать паузу дольше пяти часов.',
        ...
        MOOD_WELLBEING_DECLINE: {
            ...
            message: 'Настроение и самочувствие снижаются неделю. Стоит обсудить нагрузку с куратором.',
        ...
        WEIGHT_PLATEAU: {
            title: 'Плато веса',
            message: 'Вес стоит две недели при цели снижения. Обычно это адаптация обмена, а не ошибка учёта.',
        ...
        SODIUM_EXCESS: {
            ...
            message: 'Соли больше нормы три дня подряд. Утренний вес в такие дни завышен из-за воды.',
        ...
        CIRCADIAN_DISRUPTION: {
            ...
            message: 'Приёмы пищи и сон разъезжаются по времени. Ровный режим обычно даётся организму легче.',
        ...
        TRAINING_WITHOUT_RECOVERY: {
            ...
            message: 'Три тренировки за пять дней при коротком сне. Восстановление не успевает за нагрузкой.',
        ...
        FAT_QUALITY_DECLINE: {
            ...
            message: 'Баланс жиров смещён неделю. Помогает добавить рыбу или горсть грецких орехов.',
        ...
        SUGAR_DEPENDENCY: {
            ...
            message: 'Быстрого сахара много неделю подряд. После таких дней тяга к сладкому обычно усиливается.',
        ...
        MICRONUTRIENT_GAP: {
            ...
            message: 'Несколько микронутриентов ниже нормы одновременно. Стоит показать эти дни куратору.',
        ...
        STEP_DECLINE: {
            ...
            message: 'Шагов вдвое меньше обычного за последнюю неделю. Бытовая активность заметно снизилась.',
        ...
        MEAL_TIMING_DRIFT: {
            ...
            message: 'Завтрак сдвигается больше чем на два часа между днями. Ровное время обычно ровнее держит аппетит.',
