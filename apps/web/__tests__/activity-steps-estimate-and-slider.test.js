...
//   • «поставьте факт ползунком» — а захват висел только на маленькой точке в
//     левом краю. Теперь точка видима, а удобная зона ввода — вся полоса.
//
...
describe('Полосу шагов можно тянуть', () => {
  ...
  it('захват стоит на всей полосе, а не только на видимой точке', () => {
