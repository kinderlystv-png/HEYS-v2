...
describe('два самых частых объёма за месяц', () => {
  ...
  it('считает два самых частых объёма по журналу за месяц', () => {
  ...
  it('старше месяца в счёт не идёт', () => {
    seedDay('client-a', '2026-06-01', [330, 330, 330, 750, 750]);
    const api = loadWaterModule();
    expect(api.getFrequentVolumes('2026-08-20')).toEqual([200, 500]);
  });
