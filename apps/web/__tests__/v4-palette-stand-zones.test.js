...
const STAND_COVERAGE_GAPS = Object.freeze({
  ...
  subscription: 'paywall + readonly + badge + sub-screen + очередь на пробу, согласие, только чтение; не все 15 кадров subscription canvas',
  ...
  'curator-edits': 'ca-modal meal-card + ack/later + разворот продуктов, повторы, несколько дней',
