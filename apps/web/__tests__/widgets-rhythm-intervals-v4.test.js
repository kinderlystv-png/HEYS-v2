...
describe('Ритм приёмов · Интервалы — сведённый кусок', () => {
  ...
  it('читает пятнадцать строк кадра из актуального data-v', () => {
    ...
    expect(contractValue(canvas, 'Ритм приёмов · Интервалы · 04'))
      .toBe('«4 приёма» — моноцифры: шрифт 600 9px/1 Manrope,sans-serif, цвет var(--ink-2)');
    ...
    expect(contractValue(canvas, 'Ритм приёмов · Интервалы · 06'))
      .toBe('«3:37» — моноцифры: шрифт 600 26px/.9 Manrope,sans-serif, трекинг -.03em, цвет var(--tx)');
    ...
    expect(contractValue(canvas, 'Ритм приёмов · Интервалы · 09'))
      .toBe('«8:40 → 13:05» — моноцифры: флекс none, ширина 74px, шрифт 600 8.5px/1 Manrope,sans-serif, цвет var(--ink-2)');
    ...
    expect(contractValue(canvas, 'Ритм приёмов · Интервалы · 12'))
      .toBe('«4 ч 25 м» — моноцифры: флекс none, шрифт 600 8.5px/1 Manrope,sans-serif, цвет var(--tx)');
