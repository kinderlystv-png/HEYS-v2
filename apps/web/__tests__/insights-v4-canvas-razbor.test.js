...
describe('Инсайты · разбор кадров канваса', () => {
  ...
  const DEVIATIONS = [
    ...
    'Инсайты · подробно · 01',
    'Инсайты · 21',
    // «Инсайты · ярус Питание · 14» — вердикт «?» 06.09: граница окна vs время
    // последнего приёма (insights/pi_ui_dashboard.js:2596).
    ...
    'Инсайты · считаем · 12',
    'Инсайты · считаем · 13',
    // «Инсайты · считаем · текст» — вердикт «—» designer-removed 06.09:
    // SkeletonCard не вызывается, знак ожидания один — спиннер.
