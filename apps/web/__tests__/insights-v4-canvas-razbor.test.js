...
describe('Инсайты · разбор кадров канваса', () => {
  ...
  const DEVIATIONS = [
    ...
    // Кнопка «Ещё N» сведена пакетом 43: 600 12px/1 min-height 44 без фона —
    // 734-ui-v4-insights.css:109 .insights-v4-attention__more.
    ...
    // Невыбранный чип окна «30 дней»: цвет --v4-ink-30 сведён, min-height 44
    // против 34 px кадра — строка «минимальная область нажатия».
    'Инсайты · 63',
  ];
