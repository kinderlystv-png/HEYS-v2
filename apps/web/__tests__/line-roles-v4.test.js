...
const ALLOWED = new Map(
  Object.entries({
    ...
    // Две записи Инсайтов сняты 2 сентября: основание «роли под этот тон в
    // наборе нет» перестало быть верным. Дизайнер 1 сентября закрыл лестницу
    // линий на 8 · 12 · 18 · 22 · 30 и отказался заводить промежуточные;
    // 14 % и 9 % переведены на ближайшие ступени, исключение не нужно.
