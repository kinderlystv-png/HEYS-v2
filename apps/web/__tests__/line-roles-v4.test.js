...
const ALLOWED = new Map(
  Object.entries({
    ...
    '733-ui-v4-reports.css | .reports-v4-hero__footer | border-top':
      '9 % · gamification/nutrition-tab просят 9 % отдельной строкой; плюс блок песочно-залочен',
    '733-ui-v4-reports.css | .reports-v4-days__row | border-bottom':
