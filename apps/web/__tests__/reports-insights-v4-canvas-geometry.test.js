...
describe('Отчёты и Инсайты v4 — сверка с канвасом', () => {
  ...
  it('отступления названы и не разрастаются молча', () => {
    ...
    const DEVIATIONS = [
      ...
      // Ярус «Каскад» кадра «Инсайты», элементы 25–51. Причина одна на все
      // двадцать семь: их рисует не инсайтовый CSS, а общий
      // 740-cascade-card.css — пре-v4 компонент чужой зоны. Семейства
      // insights-v4-cascade не существует вовсе, поэтому сверять пары не с
      // чем: это не расхождение чисел, а отсутствие своей реализации.
      'Инсайты · 25',
      'Инсайты · 26',
      'Инсайты · 27',
      'Инсайты · 28',
