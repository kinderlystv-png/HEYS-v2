...
const SCORE = [
  ...
  [16, '.heys-score-screen__row-label', ['fontWeight', 'fontSize', 'lineHeight']],
...
describe('Отчёты и Инсайты v4 — сверка с канвасом', () => {
  ...
  it('отступления названы и не разрастаются молча', () => {
    ...
    const DEVIATIONS = [
      ...
      // Полоса строки каскада Score: кадр складывает строку в два этажа и
      // даёт полосе высоту 5 во всю ширину, продукт собирает её в ряд с
      // полосой 8 между именем и числом. Перестановка трогает разметку
      // heys_cascade_card_v1.js; записано дизайнеру.
      'Разбор Score · 19',
      'Разбор Score · 20',
      'Разбор Score · 21',
      'Разбор Score · 22',
