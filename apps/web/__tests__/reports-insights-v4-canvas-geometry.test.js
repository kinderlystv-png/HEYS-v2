...
describe('Отчёты и Инсайты v4 — сверка с канвасом', () => {
  ...
  it('отступления названы и не разрастаются молча', () => {
    ...
    const DEVIATIONS = [
      ...
      // Выбор окна: кадр рисует текстовые вкладки с подчёркиванием, строка
      // контракта описывает чипы-пилюли 28 радиусом 999 на --acs/--c2. Взят
      // кадр — он согласован во всех четырёх палитрах, и область нажатия 44
      // в нём уже заложена отрицательными полями.
      'вид · шапка и период',
