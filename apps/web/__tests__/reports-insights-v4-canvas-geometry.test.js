...
describe('Отчёты · разбор кадров канваса', () => {
  ...
  //
  // Удаление — отдельная задача: правила остались от снятых блоков (средние
  // числа самочувствия ушли в итог периода, действия нулевой строки сняты).
  it('мёртвые правила зоны названы поимённо и остаются мёртвыми', () => {
    const DEAD = [
      ...
      // Средние числа самочувствия — сняты, стоят в итоге периода.
      'reports-v4-wellbeing__grid',
      'reports-v4-wellbeing__item',
      'reports-v4-wellbeing__label',
      'reports-v4-wellbeing__value',
      // Действия нулевой строки матрицы — сняты.
      'reports-v4-zero-actions',
      'reports-v4-zero-actions__chevron',
      'reports-v4-zero-actions__row',
      'reports-v4-zero-actions__row--link',
    ];
