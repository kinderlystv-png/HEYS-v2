...
// Строка контракта settings-system «отключение уведомлений после согласия»:
// согласие спрашивается один раз при регистрации и заново не запрашивается —
// тумблер включается и выключается свободно, сколько угодно раз.
//
