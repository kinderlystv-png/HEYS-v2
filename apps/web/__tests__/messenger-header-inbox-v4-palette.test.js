...
const EXPECT = Object.freeze({
  sand: {
    ...
    actText: '#8a4a20',
    accentBg: '#f0dcc6',
    // 56 %, а не 55 %: решение дизайнера 7 сентября после пересчёта по WCAG.
    // Доля берётся по самой тёмной поверхности набора --v4-hero #efe3cf, где
    // 55 % давали 4,48 — ниже порога 4,5. Литерал здесь потому, что это и есть
    // значение роли в наборе; меняется оно только вместе с палитрой.
