...
const DELEGATED = new Set([
  ...
  '.nutrition-v4-streak',
  // Тот же раздел ответственности у листа правки: строка «лист правки приёма —
  // не здесь» отдаёт его food-meal с той же оговоркой «при расхождении верен
  // food-meal». Кадры расходятся: «Удалить приём» здесь 600 12 px с зазором 7,
  // в food-meal — 700 12,5 px с зазором 8.
  '.nutrition-v4-sheet__delete',
]);
