...
function normalize(value) {
  return String(value)
    ...
    // --v4-line, кроме 12 % — контракт «вид мини-карточек» просит именно
    // этот процент, а --v4-line даёт 8 %, поэтому у 12 % своя роль.
    .replace(/rgba\(var\(--ink\)\s*,\s*\.12\)/gi, 'var(--v4-ink-12)')
