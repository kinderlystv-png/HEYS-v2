...
describe('дефолтный набор · контракт home-widgets', () => {
  ...
  // Состав из строки контракта «состав дефолта». Два отступления названы в
  // UI_V4_FINDINGS и в комментариях DEFAULT_LAYOUT: «Тепловая карта» стоит
  // видом «Как сейчас» (так рисует кадр), «Динамика веса» — видом «Кривая»
  // («За месяц», решение владельца 20 августа).
  const EXPECTED = [
    ['calories', '2x2', 'hero'],
