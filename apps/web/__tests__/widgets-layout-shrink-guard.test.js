...
describe('дефолтный набор · контракт home-widgets', () => {
  ...
  // Состав из строки контракта «состав дефолта». Пакет 22 августа закрыл оба
  // прежних отступления: контракт теперь сам называет у тепловой карты «Как
  // сейчас», а у динамики веса — «За месяц» кривой, ровно как стоит в коде.
  const EXPECTED = [
    ['calories', '2x2', 'hero'],
