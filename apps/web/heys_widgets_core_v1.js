...
(function (global) {
  ...
  const DEFAULT_LAYOUT = [
    ...
    {
      // Решение владельца 29 августа: два 1×1 уезжают в шестой ряд, чтобы
      // последний ряд закрывали две 2×1. 1×1 в нижнем углу запрещён строкой
      // «1×1 в нижнем углу не ставится»: зона кнопки 52×52 забирает у такой
      // плитки больше половины площади.
      type: 'protein',
      size: '1x1',
