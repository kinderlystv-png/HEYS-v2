...
(function () {
  ...
  const PRODUCT_CATEGORIES = {
    vegetables: {
      ...
      goodAdvice: 'Овощи на сегодня в норме'
    },
    fruits: {
      ...
      goodAdvice: 'Фрукты на сегодня достаточно'
    },
    dairy: {
      ...
      goodAdvice: 'Кальций на сегодня достаточно'
    },
    fish: {
      ...
      goodAdvice: 'Омега-3 на сегодня достаточно'
    },
    meat: {
      ...
      goodAdvice: 'Белок на сегодня достаточно'
    },
    grains: {
      ...
      goodAdvice: 'Энергия на сегодня достаточна'
    },
    nuts: {
    ...
    eggs: {
      ...
      goodAdvice: 'Белок на сегодня в норме'
    }
  };
  ...
  const STREAK_MILESTONES = [
    { days: 3, icon: '🔥', text: 'Ещё ${remain} дней до серии трёх дней' },
    { days: 7, icon: '⭐', text: 'Ещё ${remain} дней до серии семи дней' },
    { days: 14, icon: '💎', text: 'Ещё ${remain} дней до серии четырнадцати дней' },
    { days: 30, icon: '🏆', text: 'Ещё ${remain} дней до серии тридцати дней' }
  ];
  ...
  const COMBO_ACHIEVEMENTS = [
    {
      ...
      daysRequired: 3,
      icon: '💪🥗',
      text: 'Три дня подряд белок и клетчатка в норме'
    },
    {
      ...
      daysRequired: 3,
      icon: '⚖️',
      text: 'Три дня баланса БЖУ в норме'
    },
    {
      id: 'hydration_master',
    ...
    },
    {
      ...
      daysRequired: 3,
      icon: '🌿',
      text: 'Три дня без избытка вредных продуктов'
    },
    {
      id: 'early_bird',
      name: 'Ранняя пташка',
      ...
      daysRequired: 5,
      icon: '🌅',
      text: 'Пять дней раннего завтрака'
    }
  ];
