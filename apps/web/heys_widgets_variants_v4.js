...
(function (global) {
  ...
  const CATALOG = {
    ...
    crashRisk: [
      ...
      // быть мёртвой веткой. Шестая карточка идёт против строки контракта
      // «максимум видов» (пять) и против кадра «Смена вида · лист выбора», где
      // нарисованы пять, — расхождение названо в docs/ui/UI_V4_FINDINGS.md.
      { id: 'chart', title: 'График', subtitle: 'динамика за 30 дней в 2×2', size: '2x2', sheet: true }
    ]
  };
