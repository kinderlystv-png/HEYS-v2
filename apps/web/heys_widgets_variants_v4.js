...
(function (global) {
  ...
  const CATALOG = {
    ...
    // Два тренда и плитка дня. Дефолт — «Неделя»: строка «шаги» (22 августа)
    // оставляет тренды главными, потому что в течение дня числа шагов ещё нет.
    // Кадр «Шаги · Как сейчас» нарисован 15 сентября строкой «вид · плитка
    // шагов» — 1×1 с числом за день и полосой до цели; до чек-ина она честно
    // показывает прочерк («шаги · нет данных»), а не вчерашнее число. Две
    // строки пакета при этом спорят — запись в UI_V4_FINDINGS.md.
    steps: [
      { id: 'week', title: 'Неделя', subtitle: 'семь столбиков и среднее', size: '2x1', isDefault: true },
      { id: 'now', title: 'Как сейчас', subtitle: 'число за день и полоса до цели', size: '1x1' },
