...
(function (global) {
  ...
  const CURRENT_VERSIONS = {
    user_agreement: '1.7',  // 2026-07-27: возвраты, прекращение подписки, SLA и ПЭП
    ...
    marketing: '1.3',
    payment_oferta: '1.7',  // payment_oferta фиксирует акцепт Пользовательского соглашения той же версии
