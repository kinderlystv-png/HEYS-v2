...
(function (global) {
  ...
  const CURRENT_VERSIONS = {
    user_agreement: '1.10', // 2026-08-08: § 5.4 — ежедневный режим и ориентир внесения данных
    personal_data: '1.7',  // 2026-07-27: фактические фото/аудио/расшифровки, SpeechKit и analytics opt-in
    health_data: '1.5',  // 2026-07-27: + защищённая предтриальная анкета и медицинские ограничения
    marketing: '1.3',
    payment_oferta: '1.10', // payment_oferta фиксирует акцепт Пользовательского соглашения той же версии
  ...
  const CONSENT_TEXTS = {
    ...
    checkboxes: {
      ...
      health_data: {
        ...
        summary: 'Обрабатываем сведения о здоровье и ограничениях для анкеты, пульсовых зон и безопасного сопровождения куратором. Дневник, переписка и фото — под согласием на персональные данные; согласие можно отозвать.',
      ...
      marketing: {
        ...
        summary: 'Можем присылать материалы, новости и акции по email, в выбранный мессенджер или push. Это необязательно: можно отказаться без потери доступа к HEYS.',
      ...
      speech_transcription: {
        ...
        summary: 'Передаём выбранное аудио в Yandex SpeechKit, получаем текст и показываем его участникам чата; голосовое может содержать сведения о здоровье, а отказ не мешает отправке без расшифровки.',
    ...
    friendlySummaries: {
      ...
      personal_data: {
        ...
        points: [
          '📝 Храним имя и выбранный контакт для аккаунта и связи',
          '🇷🇺 Первичная база и файлы внутреннего чата хранятся в Yandex Cloud в России',
          '🔐 Доступ — у назначенного куратора и обработчиков из Политики; внешний мессенджер работает по своим правилам',
      ...
      health_data: {
        ...
        points: [
          '📋 Анкета пробного периода и ограничения по здоровью',
          '❤️ Пульсовые зоны для безопасных тренировок',
          '🛡️ Куратор учитывает ограничения при сопровождении',
          '📊 Дневник питания и переписка — под согласием на персональные данные',
