  ...
  const CONSENT_TEXTS = {
    ...
    checkboxes: {
      ...
      health_data: {
        ...
        summary: 'Обрабатываем сведения о здоровье и ограничениях для анкеты, пульсовых зон и безопасного сопровождения куратором. Дневник, переписка и фото — под согласием на персональные данные.',
