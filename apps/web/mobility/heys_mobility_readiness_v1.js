...
;(function (global) {
  ...
  function score(input) {
    ...
    return {
      ...
      blocksSession: false,
      advisory: band === 'red'
        ? 'снизить интенсивность: суставной контроль, дыхание, лёгкое восстановление'
        : band === 'yellow'
          ? 'оставить мягкий объём, без форсирования крайних положений'
          : 'можно работать по обычному плану'
    };
  }
