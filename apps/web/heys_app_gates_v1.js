    ...
    HEYS.Gates.initReactGates = function initReactGates(React) {
        ...
        if (!HEYS.DesktopGateScreen) {
            function DesktopGateScreen({ onLogout }) {
                ...
                // Кадр «Первый вход · с компьютера» и строка «вид · вход с компьютера»:
                // почему только телефон → QR и адрес вместе → «на домашний экран» →
                // тихий выход. В коде QR адрес со схемой (на сайте это
                // https://app.heyslab.ru), в строке адреса — коротко, без схемы.
                const shortUrl = currentUrl.replace('https://', '').replace('http://', '');
                return React.createElement('div', { className: 'desktop-gate' },
                    React.createElement('div', { className: 'desktop-gate__col' },
                        React.createElement('span', { className: 'desktop-gate__badge' },
                            React.createElement('svg', { width: 28, height: 28, viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', strokeWidth: 2.5, strokeLinecap: 'round', strokeLinejoin: 'round', 'aria-hidden': 'true' }, React.createElement('rect', { x: 6, y: 2, width: 12, height: 20, rx: 3 }), React.createElement('path', { d: 'M11 19h2' }))
                        ),
                        React.createElement('h1', { className: 'desktop-gate__title' }, 'HEYS работает на телефоне'),
                        React.createElement('p', { className: 'desktop-gate__text' },
                            'Дневник, чек-ин и советы рассчитаны на экран в руке. Откройте этот адрес на телефоне — данные уже там.'),
                        React.createElement('div', { className: 'desktop-gate__ways' },
                            React.createElement('span', { className: 'desktop-gate__qr' },
                                React.createElement('img', { src: qrSrc, alt: `QR-код с адресом ${currentUrl}`, width: 198, height: 198 })
                            ),
                            React.createElement('div', { className: 'desktop-gate__side' },
                                React.createElement('span', { className: 'desktop-gate__label' }, 'Наведите камеру телефона'),
                                React.createElement('div', { className: 'desktop-gate__url-row' },
                                    React.createElement('span', { className: 'desktop-gate__url' }, shortUrl),
                                    React.createElement('button', {
                                        type: 'button',
                                        className: 'desktop-gate__copy-btn',
                                        onClick: onCopyUrl
                                    },
                                        React.createElement('svg', { width: 13, height: 13, viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', strokeWidth: 2.75, strokeLinecap: 'round', strokeLinejoin: 'round', 'aria-hidden': 'true' }, React.createElement('rect', { x: 9, y: 9, width: 12, height: 12, rx: 2 }), React.createElement('path', { d: 'M5 15V5a2 2 0 0 1 2-2h8' })),
                                        copyLabel
                                    )
                                ),
                                React.createElement('span', { className: 'desktop-gate__hint' }, 'Или наберите руками — адрес короткий.')
                            )
                        ),
                        React.createElement('div', { className: 'desktop-gate__home' },
                            React.createElement('div', { className: 'desktop-gate__home-title' }, 'Поставить на домашний экран'),
                            React.createElement('div', { className: 'desktop-gate__home-text' },
                                'В браузере телефона откройте меню и выберите «На экран „Домой“» — HEYS запустится как приложение.')
                        ),
                        onLogout && React.createElement('button', {
                            ...
                            React.createElement('svg', { width: 16, height: 16, viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', strokeWidth: 2.5, strokeLinecap: 'round', strokeLinejoin: 'round', 'aria-hidden': 'true' }, React.createElement('path', { d: 'M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4' }), React.createElement('path', { d: 'M16 17l5-5-5-5M21 12H9' })),
                            'Выйти из аккаунта'
                        )
                    )
                );
