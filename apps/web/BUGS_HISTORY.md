...
`HEYS.models.buildProductIndex`, тогда чинятся все точки разом. Не сделано в
этой задаче: выходит за её scope и задевает файлы, которые в момент правки были
в работе у других сессий.
