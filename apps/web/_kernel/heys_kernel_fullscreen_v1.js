...
//
// Третья реализация одного и того же каркаса: два других тренировочных режима
// уже написали его каждый по-своему, в своих доменных модулях. Силовой
// конструктор не стал третьей копией — общее вынесено сюда как generic, по
// правилу двух/трёх из CLAUDE.md. Переезд прежних режимов на этот каркас —
// отдельная задача, он в редизайн силовой не входит.
//
