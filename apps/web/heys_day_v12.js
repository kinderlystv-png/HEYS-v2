/*
┌─────────────────────────────────────────────────────────────────────────────────────────┐
│ 🗺️ НАВИГАЦИОННАЯ КАРТА ФАЙЛА heys_day_v12.js (1112 строк)                               │
├─────────────────────────────────────────────────────────────────────────────────────────┤
│ 📋 СТРУКТУРА ФАЙЛА:                                                                       │
│                                                                                           │
│ 🛠️ УТИЛИТЫ И ИНИЦИАЛИЗАЦИЯ (строки 1-80):                                               │
│    ├── Базовые утилиты: pad2, todayISO, fmtDate, parseISO, uid (1-15)                  │
│    ├── Функции localStorage: lsGet, lsSet (16-50)                                       │
│    ├── Функции времени: parseTime, addMinutes, sleepTime (51-80)                        │
│                                                                                           │
│ 📊 УПРАВЛЕНИЕ ПРОДУКТАМИ (строки 81-250):                                                │
│    ├── getAllProducts() - получение всех продуктов (81-110)                             │
│    ├── saveProduct() - сохранение продукта (111-140)                                    │
│    ├── deleteProduct() - удаление продукта (141-170)                                    │
│    ├── searchProducts() - поиск продуктов (171-200)                                     │
│    └── getProductCategories() - категории (201-250)                                     │
│                                                                                           │
│ 📅 ДНЕВНЫЕ ДАННЫЕ (строки 251-450):                                                      │
│    ├── getDayData() - получение данных дня (251-300)                                    │
│    ├── saveDayData() - сохранение данных (301-350)                                      │
│    ├── calculateDayStats() - статистика дня (351-400)                                   │
│    └── validateDayData() - валидация данных (401-450)                                   │
│                                                                                           │
│ ⚛️ REACT КОМПОНЕНТ DayTab (строки 451-900):                                              │
│    ├── Конструктор и инициализация (451-500)                                            │
│    ├── State management (501-550)                                                        │
│    ├── Event handlers (551-650):                                                         │
│    │   ├── handleProductAdd() (551-580)                                                 │
│    │   ├── handleProductEdit() (581-610)                                                │
│    │   ├── handleProductDelete() (611-640)                                              │
│    │   └── handleSearch() (641-650)                                                     │
│    ├── Render методы (651-800):                                                          │
│    │   ├── renderProductForm() (651-700)                                                │
│    │   ├── renderProductList() (701-750)                                                │
│    │   ├── renderStats() (751-780)                                                      │
│    │   └── renderDayInfo() (781-800)                                                    │
│    └── Main render() (801-900)                                                           │
│                                                                                           │
│ 🎨 UI КОМПОНЕНТЫ (строки 901-1000):                                                      │
│    ├── ProductCard - карточка продукта (901-930)                                        │
│    ├── StatsWidget - виджет статистики (931-960)                                        │
│    ├── SearchBox - поиск (961-980)                                                      │
│    └── DatePicker - выбор даты (981-1000)                                               │
│                                                                                           │
│ 🔗 ЭКСПОРТ И ИНИЦИАЛИЗАЦИЯ (строки 1001-1051):                                           │
│    ├── HEYS.DayTab - экспорт компонента (1001-1020)                                     │
│    ├── HEYS.Day - вспомогательные функции (1021-1040)                                   │
│    └── Финальная инициализация (1041-1051)                                              │
│                                                                                           │
├─────────────────────────────────────────────────────────────────────────────────────────┤
│ 🎯 БЫСТРЫЙ ПОИСК:                                                                        │
│    • Найти функцию: Ctrl+F "function " + название                                       │
│    • Работа с продуктами: строки 81-250                                                 │
│    • React компонент: строки 451-900                                                    │
│    • Event handlers: строки 551-650                                                     │
│    • Render методы: строки 651-800                                                      │
│    • UI компоненты: строки 901-1000                                                     │
└─────────────────────────────────────────────────────────────────────────────────────────┘
*/
