...
export default defineConfig({
  ...
  test: {
    ...
    // подряд; 6 форков — 707 файлов и 7699 тестов без единой такой ошибки. Того
    // же дня потолок опущен до 3 (db9dd8be5): файлов стало 708, и шести уже не
    // хватало. Доказано двумя полными прогонами подряд — ошибка плавающая, и
    // один прогон её не опровергает. Поднимать обратно без такой же пары
    // прогонов нельзя.
