...
export const ACTION_EVIDENCE: Record<string, RuleEvidenceId> = {
  eat_ready_meal: 're_action_effect_contract', eat_quick_base: 're_action_effect_contract', prepare_simple_meal: 're_action_effect_contract', cook_meal_batch: 're_habit_skill_future_geometry', order_food: 're_financial_pressure_choice', drink_coffee_100: 're_caffeine_timing_sleep',
  walk_short: 're_movement_affect_response', rest_short: 're_action_effect_contract', train_light: 're_movement_affect_response', train_planned: 're_movement_affect_response', work_standard: 're_multifactor_task_geometry', work_fast: 're_multifactor_task_geometry', work_careful: 're_multifactor_task_geometry',
