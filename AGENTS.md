...
- Бандл для превью собирается отдельно и в коммит не идёт.
...
репозитории при таком флоу постепенно устаревают; для прода это безразлично, а
свежий клон догоняет первой локальной сборкой.
...
- Перед докладом «готово» вдумчиво проверь diff своих изменений: verify и review
