...
--
-- Сырьё живёт в Cloud Logging (одна JSON-строка `t="mcp_call"` на вызов).
-- Пока это folder default group: её retention не укорачивать. Сюда суточный
-- джоб складывает только агрегат: ни одного идентификатора человека, ни
