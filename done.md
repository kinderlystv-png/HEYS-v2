...
### 🔥 Refeed Day Check-in — UI для дней восстановления ✅ (2025-12-12)

- [x] **Промпт** — `docs/tasks/2025-12-12-refeed-day-checkin.md` создан
- [x] **Бейдж "🔥 REFEED DAY"** — заменяет статус в goal progress header при `needsRefeed === true`
- [x] **Tooltip** — hover на бейдж показывает объяснение концепции и триггеров
- [x] **Визуализация долга** — компактная подсказка под progress bar с суммой долга
- [x] **3 совета про Refeed** — `refeed_recommended`, `refeed_in_progress`, `refeed_completed`
- [x] **Приоритизация советов** — refeed советы замещают обычные debt советы
- [x] Цветовая кодировка — оранжевый (#f59e0b) для refeed vs зелёный для обычного долга
- [x] JavaScript syntax check PASS ✅

**Концепция**: Снятие психологического напряжения — пользователь понимает что +35% это НЕ срыв, а часть стратегии восстановления метаболизма.
